...
- **Fiat 500e**: a real, well-populated secondhand market — €13,990-18,350 for 2023 cars with 5,000-35,000km, vs. a steep €28,900-37,900 new-price range (new prices rose sharply for the current generation). This is one of the widest new-vs-used gaps surveyed and a strong candidate for a short-range, budget-focused use case.

**Too new to have a real secondhand market yet:** Renault Twingo E-Tech (launched 2024-2025) and Citroën ë-C3 both returned essentially no used listings — search results for "occasion" on both come back with new-car pricing/offers instead. Same caveat as BYD Dolphin Surf/Atto 3 above. Worth re-checking in 6-12 months as lease returns and early buyers start reselling; for now, these are new-only options.
