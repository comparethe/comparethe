...
**Too new to have a real secondhand market yet:** Renault Twingo E-Tech (launched 2024-2025) and Citroën ë-C3 both returned essentially no used listings — search results for "occasion" on both come back with new-car pricing/offers instead. Same caveat as BYD Dolphin Surf/Atto 3 above. Worth re-checking in 6-12 months as lease returns and early buyers start reselling; for now, these are new-only options. ë-C3 is additionally ruled out on safety (see below); Twingo E-Tech's safety is unproven either way.

## Safety (Euro NCAP) — a late but decisive factor for a family/school-run car

Not checked until price had already narrowed the budget shortlist — but it turned out to matter more than price for this use case, and reshuffled the list:
...
| Citroën ë-C3 | **0 stars adult / 1 star child** (Global NCAP) | Poor chest protection, no passenger-side airbag disconnect switch |
...
**Practical effect on the budget/family shortlist:** Dacia Spring, Renault Zoe, and Citroën ë-C3 are out despite attractive prices — a 0-1 star rating means real, tested weaknesses in occupant protection, not a rounding-error gap from 4-5 stars. **Nissan Leaf becomes the top budget/family pick** — best safety of anything surveyed (new or used), competitive price, real secondhand market, proper 5-door practicality. Fiat 500e is the solid second choice. This also settles the new-vs-secondhand question for this use case: the only cheap *new* options (Spring, ë-C3) fail safety badly, and the one plausible clean new option (Twingo E-Tech) is unproven — secondhand Leaf beats "new with incentive" on both price and safety right now.

Sources: [Euro NCAP — Nissan Leaf](https://europe.nissannews.com/en-GB/releases/new-nissan-leaf-achieves-5-star-safety-rating-in-euro-ncap-crash-tests-first-car-to-be-tested-under-stringent-new-2018-protocol) · [InsideEVs — Fiat 500e 4-star rating](https://insideevs.com/news/555517/fiat-500-electric-safety-euroncap/) · [Euro NCAP — Fiat 500e](https://www.euroncap.com/assessments/fiat/500e/0911/) · [MotorBeam — Dacia Spring 1-star rating](https://www.motorbeam.com/dacia-spring-electric-euro-ncap-safety-test-rating-is-1-star/) · [Euro NCAP — Dacia Spring](https://www.euroncap.com/en/results/dacia/spring/44197) · [Global NCAP — Citroën ë-C3 zero-star rating](https://www.globalncap.org/news/stellantis-zeroes-out-on-safety-with-citron-c3) · [Autocar — Renault Zoe zero-star rating](https://www.autocar.co.uk/car-news/new-cars/renault-zoe-given-zero-stars-euro-ncap-safety-tests) · [autoevolution — Renault Twingo E-Tech, untested/expected 4-star](https://www.autoevolution.com/news/all-new-renault-twingo-receives-4-star-rating-from-euro-ncap-video-86035.html)
